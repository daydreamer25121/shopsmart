...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$flags_webgpu$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@tensorflow/tfjs-backend-webgpu/dist/flags_webgpu.js [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$adapter_info$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@tensorflow/tfjs-backend-webgpu/dist/adapter_info.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$buffer_manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@tensorflow/tfjs-backend-webgpu/dist/buffer_manager.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$texture_manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@tensorflow/tfjs-backend-webgpu/dist/texture_manager.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$webgpu_program$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@tensorflow/tfjs-backend-webgpu/dist/webgpu_program.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$webgpu_util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/@tensorflow/tfjs-backend-webgpu/dist/webgpu_util.js [app-ssr] (ecmascript)");
...
const CPU_HANDOFF_SIZE_THRESHOLD = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$environment$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["env"])().getNumber('WEBGPU_CPU_HANDOFF_SIZE_THRESHOLD');
...
const reshapeDispatch = (device, program)=>{
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(dispatch[0] > MAX_COMPUTE_PER_DIMENSION_DISPATCH_SIZE && layout.y === undefined && layout.z === undefined, ()=>'Dispatch size exceeds WebGPU limits in Y or Z dimension.');
    let dispatchAverage = Math.ceil(Math.sqrt(dispatch[0]));
    if (dispatchAverage > MAX_COMPUTE_PER_DIMENSION_DISPATCH_SIZE) {
        dispatchAverage = Math.ceil(Math.cbrt(dispatch[0]));
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(dispatchAverage <= MAX_COMPUTE_PER_DIMENSION_DISPATCH_SIZE, ()=>'Total dispatch size exceeds WebGPU maximum.');
        return [
            dispatchAverage,
            dispatchAverage,
            dispatchAverage
...
class WebGPUBackend extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["KernelBackend"] {
    nextDataId() {
    ...
    constructor(device, adapterInfo){
        ...
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$webgpu_util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.isWebGPUSupported()) {
        ...
        this.adapterInfo = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$adapter_info$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AdapterInfo"](adapterInfo);
        ...
        this.bufferManager = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$buffer_manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BufferManager"](this.device);
        this.textureManager = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$texture_manager$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TextureManager"](this.device);
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$environment$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["env"])().getBool('WEBGPU_USE_PROFILE_TOOL')) {
    ...
    async getBufferData(buffer) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$environment$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["env"])().getBool('WEBGPU_ENGINE_COMPILE_ONLY')) {
        ...
        // to capture a frame
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$environment$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["env"])().getBool('WEBGPU_USE_PROFILE_TOOL')) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(this.dummyContext !== undefined, ()=>`Fail to get context for profiling tool`);
    ...
    readSync(dataId) {
        ...
        if (tensorData.dtype === 'complex64') {
            ...
            const complexVals = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].convertBackendValuesAndArrayBuffer(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$backends$2f$backend_util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__backend_util$3e$__["backend_util"].mergeRealAndImagArrays(realValues, imagValues).buffer, 'float32');
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(bufferSize % 4 === 0, ()=>'Because there is 4 bytes for ' + 'one pixel, buffer size must be multiple of 4.');
        ...
        const vals = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].convertBackendValuesAndArrayBuffer(valsGPU, tensorData.dtype);
    ...
    async read(dataId) {
        ...
        if (tensorData.dtype === 'complex64') {
            ...
            vals = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].convertBackendValuesAndArrayBuffer(data, tensorData.dtype);
        }
        this.convertAndCacheOnCPU(dataId, vals);
        return vals;
    }
     ...
     */ createTensorFromGPUData(webGPUData, shape, dtype) {
        ...
        const tensorData = this.tensorMap.get(dataId);
        const size = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$webgpu_util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.GPUBytesPerElement(tensorData.dtype) * __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(tensorData.shape);
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["engine"])().makeTensorFromDataId(dataId, shape, dtype, this);
    }
    /**
     ...
     */ readToGPU(dataId) {
        ...
        const tensorRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$globals$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["engine"])().makeTensorFromTensorInfo(tensorInfo);
    ...
    makeTensorInfo(shape, dtype, values) {
        if (dtype === 'string' && values != null && values.length > 0 && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].isString(values[0])) {
            values = values.map((d)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].encodeString(d));
        }
        ...
        programUniform.forEach((d)=>{
            ...
            switch(d.data.length){
                ...
                case 6:
                    ...
                    break;
                default:
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].assert(false, ()=>`Unsupported ${d.data.length}D shape`);
            }
    ...
    runWebGPUProgram(program, inputs, outputDtype, programDefinedUniform, output) {
        ...
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(output.shape) === 0) {
            ...
            // shape).
            this.tensorMap.get(output.dataId).values = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].getTypedArrayFromDType(output.dtype, 0);
            return output;
        }
        ...
        program.shaderKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$webgpu_program$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.makeShaderKey(program, inputsData, output);
        const parallelCompilation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$environment$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["env"])().getBool('WEBGPU_ENGINE_COMPILE_ONLY');
        if (!(program.shaderKey in this.pipelineCache)) {
            this.pipelineCache[program.shaderKey] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$webgpu_program$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.compileProgram(this.device, program, inputsData, output, parallelCompilation);
        }
    ...
    recordAndSubmit(program, output, inputs, programDefinedUniform) {
        ...
        if (program.pixelsOpType == null) {
            ...
            bufferShapes.map((d)=>{
                ...
                const strides = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].computeStrides(d);
                programUniform.push({
                    type: uniformsType,
                    data: strides
                });
            ...
            const strides = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].computeStrides(output.shape);
            programUniform.push({
                type: uniformsType,
                data: strides
            });
        ...
        if (program.size) {
            const size = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$util$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__util$3e$__["util"].sizeFromShape(program.outputShape);
            programUniform.push({
                type: uniformsType,
                data: [
        ...
        if (shouldTimeProgram || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$core$2f$dist$2f$environment$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["env"])().get('WEBGPU_DEFERRED_SUBMIT_BATCH_SIZE') <= this.dispatchCountInPass || program.pixelsOpType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tensorflow$2f$tfjs$2d$backend$2d$webgpu$2f$dist$2f$webgpu_program$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__.PixelsOpType.DRAW) {
            this.endComputePassEncoder();
...
//# sourceMappingURL=node_modules_%40tensorflow_tfjs-backend-webgpu_dist_backend_webgpu_fff455.js.map